...
fun FragmentActivity.navigateFragment(
    ...
    @IdRes viewId: Int = R.id.container,
...
// todo: fragment olduğu için bundle gerek kalmayabilir, denemek lazım.
...
fun FragmentActivity.returnPage(clazz: KClass<out Fragment>, args: Bundle? = null) {
    val fm = supportFragmentManager
